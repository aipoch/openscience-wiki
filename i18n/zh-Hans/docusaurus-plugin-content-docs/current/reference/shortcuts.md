...
| Session 引用 | 输入 `#` | 输入 `#` | Composer |
| 撤销草稿/支持的归档 | `⌘Z` | `Ctrl+Z` | Composer 或支持撤销的 archive notice |
| 重做 Composer 草稿 | `⌘⇧Z` | `Ctrl+Shift+Z` | Composer |
| 关闭 active preview | `⌘W` | `Ctrl+W` | Workspace Preview |
